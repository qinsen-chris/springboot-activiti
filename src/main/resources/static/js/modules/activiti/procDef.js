$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'workFlow/procDefList',
        datatype: "json",
        colModel: [			
			{ label: 'ID', name: 'id', index: "id", width: 45, key: true },
			{ label: '流程名称', name: 'name', width: 75 },
			{ label: '流程定义key', name: 'key', width: 90 },
			{ label: '流程版本', name: 'version', width: 45 },
			{ label: '流程定义的规则文件名称', name: 'resourceName', width: 90 },
			{ label: '流程定义的规则图片名称', name: 'diagramResourceName', width: 90 },
			{ label: '部署ID', name: 'deploymentId', width: 45 }
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
